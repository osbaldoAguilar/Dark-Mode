...
function Experience({formSection}) {
    ...
    const handleSubmit = (e) => {    
        ...
        dispatch({type: 'SET_XP_DATA', payload: ansArray})
    }
  ...
  return (
    <Form.Field>
        ...
        <label htmlFor="numsOfXp">Enter number of experiences you want to include</label>
        {numInputs === 0 && <input type="number" name="numsOfXp" id="numsOfXp" onChange={(e) => handleInput(e)}/>}
